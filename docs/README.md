...
> **Only cloned backend?** You still need the [frontend repo](https://github.com/icmnlab/tree-project-frontend) for almost all handover docs. Clone both repos side by side (e.g. `D:\treeproject\tree-project-backend` + `tree-project-frontend`).
